ALL_OS = {"Linux", "FreeBSD", "Windows XP", "Windows 7", "Windows 10", "Symbian", "Palm OS"}
OS_DB = {
	"DF": {
		True: {"FreeBSD", "Linux", "Windows XP", "Windows 7", "Windows 10"},
		False: {"FreeBSD", "Symbian", "Palm OS", "Linux", "Windows XP", "Windows 7", "Windows 10"}
	},
	"TTL": {
		64:	{"Linux", "FreeBSD"},
